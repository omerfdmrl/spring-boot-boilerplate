package dev.domainx.backend.config;
...
import dev.domainx.backend.user.repository.PermissionRepository;
import dev.domainx.backend.user.repository.RoleRepository;
